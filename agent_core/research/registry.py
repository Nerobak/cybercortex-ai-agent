...
def _definition(
    ...
    *,
    ...
    executor_adapter_reference: str | None = None,
) -> PrimitiveDefinition:
    return PrimitiveDefinition(
        ...
        executor_adapter_reference=executor_adapter_reference,
    )
...
_DEFAULT_DEFINITIONS = (
    _definition(
        ...
        executor_adapter_reference="research-native:request_replay/v1",
    ),
    _definition(
        "identity_switch",
        "IdentitySwitchInput",
        ...
        executor_adapter_reference="research-native:identity_switch/v1",
    ),
    _definition(
        "parameter_mutation",
        ...
        state_change=StateChangeBehavior.method_dependent,
        cleanup=CleanupBehavior.method_dependent,
        executor_adapter_reference="research-native:parameter_mutation/v1",
    ),
    _definition(
        "object_substitution",
        ...
        state_change=StateChangeBehavior.method_dependent,
        cleanup=CleanupBehavior.method_dependent,
        executor_adapter_reference="research-native:object_substitution/v1",
    ),
    _definition(
        "header_mutation",
        "HeaderMutationInput",
    ...
    _definition(
        ...
        executor_adapter_reference="research-native:response_differential/v1",
    ),
    _definition(
        "state_differential",
        ...
        executor_adapter_reference="research-native:state_differential/v1",
    ),
    _definition(
        "graphql_operation",
